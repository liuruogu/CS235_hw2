...
% View https://www.youtube.com/watch?v=-glNTjqJVps


% Here is the test data. I want to predict their class labels.
sample = [              % Here are the five items I want to classify. 
    0.9000    0.8000    % The first unknown animal
    0.1000    0.3000    % The second unknown animal
    0.2000    0.6000    % The ..
    0.1400    0.5600
    0.9322    0.8666
    0.5100    0.5073];
...
% Here is the training data. I know their class labels.
training = [            % Here are the four items in my model.
         0         0
    0.5000    0.5000
    1.0000    1.0000
    1.0000    8.4500];

group = [               % Here are there their class labels
    'dog'
    'cat'
    'pig'
    'cat'];

% Run the KNN classifer, and predict the five class labels. 
...
%% You can ignore all the code below. It was build-in to old versions of
%% matlab, but has been replaced in newer versions
%% If you happen to have an old version of matlab, you can delete below
%% this line. 
